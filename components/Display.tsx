  ...
  return (
    <div className="relative flex flex-col h-full min-h-[500px] bg-slate-900 rounded-xl overflow-hidden border border-slate-700 shadow-2xl transition-all duration-300 group">
      ...
      <div className="flex-1 relative overflow-auto custom-scrollbar p-8 flex items-center justify-center bg-slate-900">
        <pre 
            className="whitespace-pre select-all text-white inline-block tracking-normal"
            style={{ 
      ...
      <div className="p-4 bg-slate-950 border-t border-slate-800 flex justify-end">
        <button
            onClick={handleCopy}
            className={`flex items-center justify-center gap-2 px-6 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                copied 
